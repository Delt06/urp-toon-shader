...
inline void add_reflections(inout half3 fragment_color, const in float3 view_direction_ws, const in float3 normal_ws, const in float3 position_ws)
{
    ...
    fragment_color *= lerp(1, reflection, _ReflectionBlend);
} 
